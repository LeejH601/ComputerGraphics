...
uniform mat4 gInstanceWorldTransforms[MAX_INSTANCE_SIZE];
uniform uint gInstanceSize;

void main()
{
	gl_Position = projectionTransform * viewTransform * gInstanceWorldTransforms[gl_InstanceID] * vec4(v_Position, 1.0);
